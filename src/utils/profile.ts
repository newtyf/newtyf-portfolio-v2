...
export const jobs: job[] = [
  {
    title: "Datapath/Nubot",
    description: [
      "Developed scalable backend services with Express.js and FastAPI, implementing secure API Key authentication",
      "Optimized messaging backend with asynchronous Python architecture, reducing response latency by 90%",
      "Designed and managed PostgreSQL databases with Knex, including modeling, migrations, and maintenance",
      "Built React interfaces with centralized API management using Axios, improving user experience and session persistence",
      "Implemented real-time communication with Socket.IO, ensuring seamless client-server synchronization on Cloud Run",
      "Deployed and monitored services on GCP Cloud Run, managing errors and ensuring high availability",
      "Automated deployments with Docker and custom scripts for consistent environments",
    ],
  ...
  },
  {
    title: "Mediabyte",
    description: [
      "Implemented new features with Angular and AdonisJS, enhancing user experience and platform performance",
      "Optimized platform with lazy loading in Angular, improving initial load speed by 50%",
      "Documented business flows to facilitate decision-making and system evolution",
      "Modeled and optimized relational databases, establishing foundations for future microservices",
    ],
    role: "Full stack Engineer",
    start: "AGO 2024",
    end: "MAR 2025",
